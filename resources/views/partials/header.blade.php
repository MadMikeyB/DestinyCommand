<header class="border-b border-stone-200 bg-stone-50/95 backdrop-blur dark:border-zinc-800 dark:bg-zinc-900/95">
    <div class="mx-auto w-full max-w-5xl px-4 py-3 sm:px-6 lg:px-8">
        <nav class="flex items-center gap-4" aria-label="Primary">
            <a href="{{ url('/') }}" class="text-base font-semibold tracking-tight text-zinc-900 dark:text-zinc-100">DestinyCommand</a>

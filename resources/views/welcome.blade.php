...
<head>
    ...
    <title>DestinyCommand</title>
</head>
<body>
<h1>DestinyCommand</h1>

<h2>Info</h2>

<h3>What is DestinyCommand.com?</h3>
...
<h3>Nightbot (Twitch / Youtube / Discord)</h3>
...
<h3>Deepbot (Twitch / Discord)</h3>

<p><code>!addcmd !destiny @customapi@[https://destinycommand.com/api/command?query=@target@&amp;bot=deepbot&amp;user=@user@&amp;default_console=xbox&amp;channel=CHANNEL_NAME_HERE]</code></p>

<p>Required: Change <b>CHANNEL_NAME_HERE</b> to your actual channel name.</p>
...
<h3>Streamelements (Twitch / Youtube)</h3>
...
<h3>Mix It Up (Mixer)</h3>

<p>Easiest way is to download the command from the MixItUpApp store:</p>

<ol>
    <li>New command</li>
    <li>Download from Store</li>
    <li>Search "Destiny Stats"</li>
    <li>Select "Destiny Stats"</li>
    <li>Click download</li>
    <li>Insert a command name &amp; chat trigger</li>
    <li>Click Save</li>
</ol>

<p>If that doesn't work, you can create the command manually:</p>

<ol>
    <li>New command</li>
    <li>Advanced command</li>
    <li>Insert a command name &amp; chat trigger</li>
    <li>Select "Action" -> Web Request -> click +</li>
    <li>Insert "Web Request URL": <code>https://destinycommand.com/live/api/command?query=$allargs&amp;bot=mixitup&amp;user=$username&amp;channel=$streamerusername&amp;default_console=xbox</code></li>
    <li>Select "Action To Perform With Response": Chat</li>
    <li>Insert "Chat message": <code>$webrequestresult</code></li>
    <li>Click Save</li>
</ol>
...
<p>Tweet <a href="https://twitter.com/destinycommand" target="_blank" rel="noreferrer">@DestinyCommand</a> to request install info for a different bot.</p>

<h2>Help</h2>

<h3>Support</h3>

<p>Need help? Please contact us at Twitter <a href="https://twitter.com/destinycommand" target="_blank" rel="noreferrer">@DestinyCommand</a>.</p>

<h3>Contribute</h3>

<p>Like the project? Support us <a href="https://2g.be/u/donate" target="_blank" rel="noreferrer">here</a>.</p>
</body>
</html>
